                    ...
                    <div className="px-5 py-3.5 bg-slate-50/70 border-t border-slate-100 flex items-center justify-between gap-2">
                      {canManageExercise ? (
                        ...
                        <div className="w-full flex items-center justify-between">
                          ...
                          <Link
                            href={`/courses/${ex.courseId}/exercises/${ex.id}`}
                            className="inline-flex items-center gap-1.5 text-xs font-bold text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-xl transition shadow-2xs"
                          >
                            <Play className="w-3.5 h-3.5 fill-indigo-600" />
                            <span>Làm bài tập (Học viên)</span>
                          </Link>
                        </div>
                      )}
                    </div>
